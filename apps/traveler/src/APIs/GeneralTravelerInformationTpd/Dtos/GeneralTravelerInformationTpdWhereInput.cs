...
public class GeneralTravelerInformationTpdWhereInput
{
    public string? AccompaniedBaggageEntryAndExit { get; set; }
    ...
    public string? ExitVoucher { get; set; }
    ...
    public string? InspectorRatingModificationHistory { get; set; }
    ...
    public string? TpdVehicle { get; set; }

    public string? TravelerSearchHistory { get; set; }
