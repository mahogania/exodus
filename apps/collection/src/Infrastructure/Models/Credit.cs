...
public class CreditDbModel
{
    ...
    [StringLength(1000)] public string? AgencyCode { get; set; }

    [StringLength(1000)] public string? AssignedAccountant { get; set; }

    [StringLength(1000)] public string? AttachmentId { get; set; }

    [StringLength(1000)] public string? AuthorizingOfficerDesignation { get; set; }

    [StringLength(1000)] public string? AuthorizingOfficerQuality { get; set; }
    ...
    [Range(-999999999, 999999999)] public double? GuaranteeAmount { get; set; }

    [StringLength(1000)] public string? GuaranteeClosedOn { get; set; }

    [StringLength(1000)] public string? GuaranteeClosureDate { get; set; }

    [StringLength(1000)] public string? GuaranteeIssuanceNo { get; set; }

    [StringLength(1000)] public string? GuaranteeNo { get; set; }

    [StringLength(1000)] public string? GuaranteeTypeCode { get; set; }

    [StringLength(1000)] public string? GuaranteeValidityStatusCode { get; set; }
    ...
    [StringLength(1000)] public string? RejectionReasonContent { get; set; }
    ...
    [StringLength(1000)] public string? UnknownField { get; set; }
