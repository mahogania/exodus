...
[Table("NoticeOfDefaults")]
public class NoticeOfDefaultDbModel
{
    [Required] public DateTime CreatedAt { get; set; }

    [StringLength(1000)] public string? DefaultNoticeNumber { get; set; }
    ...
    [Range(-999999999, 999999999)] public double? InitialApAmount { get; set; }
    ...
    [Range(-999999999, 999999999)] public double? NumberOfDefaultNotices { get; set; }
