...
public class CertificateDbModel
{
    ...
    [StringLength(1000)] public string? BatchNo { get; set; }
    ...
    [StringLength(1000)] public string? FirstRegistrationDate { get; set; }
    ...
    [StringLength(1000)] public string? RegistrationNo { get; set; }

    [StringLength(1000)] public string? RemarkContent { get; set; }

    [StringLength(1000)] public string? SaleCertificateNo { get; set; }

    [StringLength(1000)] public string? SalePvNo { get; set; }

    [StringLength(1000)] public string? ServiceCode { get; set; }

    [StringLength(1000)] public string? TransferDecisionNo { get; set; }
