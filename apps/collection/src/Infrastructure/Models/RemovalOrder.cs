...
{
    [Range(-999999999, 999999999)] public double? ArticlePackageQuantity { get; set; }
    ...
    [StringLength(1000)] public string? CustomsZoneCode { get; set; }

    [StringLength(1000)] public string? DeclarantCode { get; set; }

    [StringLength(1000)] public string? DeclarantName { get; set; }

    [StringLength(1000)] public string? DeletionFlag { get; set; }

    [StringLength(1000)] public string? ExporterIdentificationNumber { get; set; }

    [StringLength(1000)] public string? ExporterIdentificationNumberTypeCode { get; set; }

    [StringLength(1000)] public string? ExporterName { get; set; }
    ...
    [StringLength(1000)] public string? Forwarder { get; set; }

    [Key] [Required] public string Id { get; set; }

    [StringLength(1000)] public string? ImporterIdentificationNumber { get; set; }

    [StringLength(1000)] public string? ImporterIdentificationNumberTypeCode { get; set; }

    [StringLength(1000)] public string? ImporterName { get; set; }

    [StringLength(1000)] public string? NoticeNumber { get; set; }

    [Range(-999999999, 999999999)] public double? NumberOfTimesRemovalOrderPrinted { get; set; }

    [StringLength(1000)] public string? OfficeCode { get; set; }

    [StringLength(1000)] public string? PaymentDate { get; set; }
    ...
    [StringLength(1000)] public string? RemovalOrderNumber { get; set; }
