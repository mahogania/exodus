...
public class CauseDbModel
{
    ...
    [Range(-999999999, 999999999)] public double? AmountActuallyPaid { get; set; }
    ...
    [StringLength(1000)] public string? OtherChargeableFeesCode { get; set; }

    [StringLength(1000)] public string? OtherChargeableFeesTaxCode { get; set; }
