...
public class CollectionDbModel
{
    ...
    [Range(-999999999, 999999999)] public double? CollectedAmount { get; set; }

    [StringLength(1000)] public string? CollectionBankCode { get; set; }

    [StringLength(1000)] public string? CollectionNo { get; set; }

    [StringLength(1000)] public string? CollectionTypeCode { get; set; }

    [Required] public DateTime CreatedAt { get; set; }

    [StringLength(1000)] public string? DeletionOn { get; set; }

    [StringLength(1000)] public string? ExpenseCertificateNo { get; set; }
    ...
    [StringLength(1000)] public string? ManualRegistrationReasonContent { get; set; }
    ...
    [StringLength(1000)] public string? RegistrationSystemCategoryCode { get; set; }

    [StringLength(1000)] public string? ServiceCode { get; set; }

    [StringLength(1000)] public string? TaxpayerPhoneNo { get; set; }
