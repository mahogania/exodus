...
public class FineDbModel
{
    ...
    [Range(-999999999, 999999999)] public double? FineAmountInEur { get; set; }

    [Range(-999999999, 999999999)] public double? FineAmountInUsd { get; set; }

    [StringLength(1000)] public string? FineCancellationDate { get; set; }

    [StringLength(1000)] public string? FineCancellationOfficerId { get; set; }

    [StringLength(1000)] public string? FineCancellationReasonContent { get; set; }

    [StringLength(1000)] public string? FineCancellationRequestNo { get; set; }

    [StringLength(1000)] public string? FineImpositionRequestNo { get; set; }

    [StringLength(1000)] public string? FineRegistrationReasonContent { get; set; }
    ...
    [StringLength(1000)] public string? NiuCategoryName { get; set; }

    [StringLength(1000)] public string? NoticeNo { get; set; }

    [StringLength(1000)] public string? NotificationRequiredOn { get; set; }
