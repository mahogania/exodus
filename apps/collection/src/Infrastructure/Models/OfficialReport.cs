...
{
    [StringLength(1000)] public string? AccountingMaterialManagementNumber { get; set; }

    [StringLength(1000)] public string? Address { get; set; }

    [StringLength(1000)] public string? AdjudicatorIdentificationNumber { get; set; }

    [StringLength(1000)] public string? AdjudicatorIdentificationNumberTypeCode { get; set; }

    [StringLength(1000)] public string? AdjudicatorSName { get; set; }

    [StringLength(1000)] public string? AlienationDate { get; set; }

    [StringLength(1000)] public string? AttachedFileId { get; set; }

    [Required] public DateTime CreatedAt { get; set; }

    [StringLength(1000)] public string? DecisionOfAssignmentNumber { get; set; }
    ...
    [StringLength(1000)] public string? MinutesOfDefaultNumber { get; set; }

    [StringLength(1000)] public string? MinutesOfDefaultTypeCode { get; set; }

    [StringLength(1000)] public string? OfficeCode { get; set; }

    [StringLength(1000)] public string? ReasonsForDefault { get; set; }

    [StringLength(1000)] public string? ReceiverId { get; set; }
