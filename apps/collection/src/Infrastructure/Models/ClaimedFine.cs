...
{
    [StringLength(1000)] public string? AcceptedByTaxpayerOn { get; set; }
    ...
    [StringLength(1000)] public string? OpinionRegisteredByTaxpayerOn { get; set; }
    ...
    [StringLength(1000)] public string? TinCategoryCode { get; set; }

    [StringLength(1000)] public string? TinCategoryName { get; set; }
