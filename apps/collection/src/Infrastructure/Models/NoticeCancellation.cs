...
public class NoticeCancellationDbModel
{
    ...
    [StringLength(1000)] public string? CancellationReasonContent { get; set; }
    ...
    [StringLength(1000)] public string? NoticeCancellationRequestNo { get; set; }
    ...
    [Range(-999999999, 999999999)] public double? RequestOrderNo { get; set; }
