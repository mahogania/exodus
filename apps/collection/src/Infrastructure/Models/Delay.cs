...
public class DelayDbModel
{
    ...
    [StringLength(1000)] public string? LatePaymentDate { get; set; }
    ...
    [Range(-999999999, 999999999)] public double? NumberOfTimesOfLatePayments { get; set; }

    [StringLength(1000)] public string? OfficeCode { get; set; }

    [StringLength(1000)] public string? PaymentDeadline { get; set; }

    [Range(-999999999, 999999999)] public double? PenaltyRate { get; set; }

    [StringLength(1000)] public string? PreviousDueDate { get; set; }

    [StringLength(1000)] public string? PreviousNotificationDate { get; set; }

    [StringLength(1000)] public string? ServiceCode { get; set; }

    [Range(-999999999, 999999999)] public double? TotalNoticeAmount { get; set; }

    [Range(-999999999, 999999999)] public double? TotalPreviousNoticeAmount { get; set; }
