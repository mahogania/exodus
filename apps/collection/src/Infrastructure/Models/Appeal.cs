...
public class AppealDbModel
{
    ...
    [Range(-999999999, 999999999)] public double? NumberOfOpinions { get; set; }

    [StringLength(1000)] public string? OfficeCode { get; set; }

    [StringLength(1000)] public string? OpinionContent { get; set; }

    public DateTime? RegistrationDateAndTime { get; set; }

    [StringLength(1000)] public string? ResponseContent { get; set; }
