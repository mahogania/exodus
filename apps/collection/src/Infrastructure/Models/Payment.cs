...
public class PaymentDbModel
{
    ...
    [Range(-999999999, 999999999)] public double? Cents { get; set; }

    [StringLength(1000)] public string? CheckNature { get; set; }

    [StringLength(1000)] public string? CheckType { get; set; }

    [StringLength(1000)] public string? CollectionBankCode { get; set; }

    [StringLength(1000)] public string? CollectionNo { get; set; }

    [Required] public DateTime CreatedAt { get; set; }

    [Range(-999999999, 999999999)] public double? CreditInterest { get; set; }

    [Range(-999999999, 999999999)] public double? CustomsDutiesTotalAmountToPay { get; set; }

    [StringLength(1000)] public string? DeletionOn { get; set; }

    [Range(-999999999, 999999999)] public double? DetailSequenceNo { get; set; }

    [StringLength(1000)] public string? DueDate { get; set; }

    [Range(-999999999, 999999999)] public double? FeeAmount { get; set; }
    ...
    [StringLength(1000)] public string? ImportDeclarationDate { get; set; }

    [StringLength(1000)] public string? InspectionTaxCheckDate { get; set; }

    [StringLength(1000)] public string? InspectionTaxCheckNumber { get; set; }
