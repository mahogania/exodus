...
public class ManagementOfAccountingAccountsByPaymentNoticeTypeDbModel
{
    ...
    [StringLength(1000)] public string? ApplicationStartDate { get; set; }

    [StringLength(1000)] public string? AuxiliaryJournalDesignation { get; set; }

    [StringLength(1000)] public string? BalanceSheetCategoryCode { get; set; }
    ...
    [StringLength(1000)] public string? PartialOrParticularDistribution { get; set; }

    [StringLength(1000)] public string? ReasonCodeByPaymentNoticeType { get; set; }
