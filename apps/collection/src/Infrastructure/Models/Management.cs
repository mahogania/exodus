...
public class ManagementDbModel
{
    ...
    [StringLength(1000)] public string? AccountingServiceCode { get; set; }

    [Required] public DateTime CreatedAt { get; set; }

    [StringLength(1000)] public string? DeletionOn { get; set; }

    [StringLength(1000)] public string? ErrorDate { get; set; }
    ...
    [StringLength(1000)] public string? OperationReason { get; set; }

    [StringLength(1000)] public string? OrderOperationNumber { get; set; }
    ...
    [StringLength(1000)] public string? WriterServiceCode { get; set; }
}
