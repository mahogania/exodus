...
public class AccountingDbModel
{
    ...
    [StringLength(1000)] public string? ContainerSize { get; set; }

    [Required] public DateTime CreatedAt { get; set; }

    [StringLength(1000)] public string? Crn { get; set; }

    [StringLength(1000)] public string? CustomsAreaCode { get; set; }
    ...
    [StringLength(1000)] public string? HandlingDate { get; set; }

    [Key] [Required] public string Id { get; set; }

    [StringLength(1000)] public string? ItemName { get; set; }

    [Range(-999999999, 999999999)] public double? NumberOfPackages { get; set; }

    [StringLength(1000)] public string? OfficeCode { get; set; }

    [StringLength(1000)] public string? ReferenceFileRegistrationDate { get; set; }
    ...
    [StringLength(1000)] public string? Storage { get; set; }
