...
public class CommonVerificationCreateInput
{
    ...
    public ArticlesSubmittedForVerification? ArticlesSubmittedForVerification { get; set; }

    public List<ContainerValueAssessment>? ContainerValueAssessments { get; set; }
