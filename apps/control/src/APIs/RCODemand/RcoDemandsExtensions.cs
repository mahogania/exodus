...
public static class RcoDemandsExtensions
{
    public static RCODemand ToDto(this RCODemandDbModel model)
    {
        return new RCODemand
        {
    ...
    public static RCODemandDbModel ToModel(
        this RCODemandUpdateInput updateDto,
    ...
    )
    {
        ...
        {
            rcoDemand.CreatedAt = updateDto.CreatedAt.Value;
        }
        if (updateDto.UpdatedAt != null)
        {
            rcoDemand.UpdatedAt = updateDto.UpdatedAt.Value;
        }
