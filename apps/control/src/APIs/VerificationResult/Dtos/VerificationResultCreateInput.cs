...
public class VerificationResultCreateInput
{
    public CommonVerification? CommonVerification { get; set; }
    ...
    public List<VerificationResultDetail>? VerificationResultDetails { get; set; }
