...
public abstract class ValueAssessmentsServiceBase : IValueAssessmentsService
{
    ...
    public async Task<ValueAssessment> CreateValueAssessment(ValueAssessmentCreateInput createDto)
    {
        var valueAssessment = new ValueAssessmentDbModel
        {
            ...
            DeductedAmount = createDto.DeductedAmount,
            DeductionCurrencyCode = createDto.DeductionCurrencyCode,
            DeductionExchangeRate = createDto.DeductionExchangeRate,
            DeductionNcyAmount = createDto.DeductionNcyAmount,
            FinalModificationDateTime = createDto.FinalModificationDateTime,
            FinalModifierId = createDto.FinalModifierId,
            FirstRecorderId = createDto.FirstRecorderId,
            FirstRecordingDateTime = createDto.FirstRecordingDateTime,
            FreightAmount = createDto.FreightAmount,
            FreightCurrencyCode = createDto.FreightCurrencyCode,
            FreightExchangeRate = createDto.FreightExchangeRate,
            FreightNcyAmount = createDto.FreightNcyAmount,
            InsuranceAmount = createDto.InsuranceAmount,
            InsuranceCurrencyCode = createDto.InsuranceCurrencyCode,
            InsuranceExchangeRate = createDto.InsuranceExchangeRate,
            InsuranceNcyAmount = createDto.InsuranceNcyAmount,
            InvoiceAmount = createDto.InvoiceAmount,
            InvoiceExchangeRate = createDto.InvoiceExchangeRate,
            InvoiceNcyAmount = createDto.InvoiceNcyAmount,
            InvoiceUsdAmount = createDto.InvoiceUsdAmount,
            OtherCostsAmount = createDto.OtherCostsAmount,
            OtherCostsCurrencyCode = createDto.OtherCostsCurrencyCode,
            OtherCostsExchangeRate = createDto.OtherCostsExchangeRate,
            OtherCostsNcyAmount = createDto.OtherCostsNcyAmount,
            SuppressionOn = createDto.SuppressionOn,
            TotalTaxableBaseNcyTotal = createDto.TotalTaxableBaseNcyTotal,
            TotalTaxableBaseUsdTotal = createDto.TotalTaxableBaseUsdTotal,
            TotalValueAssessmentNcyAmount = createDto.TotalValueAssessmentNcyAmount,
            TotalValueAssessmentUsdAmount = createDto.TotalValueAssessmentUsdAmount,
