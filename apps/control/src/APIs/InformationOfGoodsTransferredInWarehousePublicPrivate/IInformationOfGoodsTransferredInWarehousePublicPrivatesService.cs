...
public interface IInformationOfGoodsTransferredInWarehousePublicPrivatesService
{
    ...
    /// </summary>
    public Task<InformationOfGoodsTransferredInWarehousePublicPrivate> CreateInformationOfGoodsTransferredInWarehousePublicPrivate(
        InformationOfGoodsTransferredInWarehousePublicPrivateCreateInput informationofgoodstransferredinwarehousepublicprivate
    );
    ...
    /// </summary>
    public Task<InformationOfGoodsTransferredInWarehousePublicPrivate> InformationOfGoodsTransferredInWarehousePublicPrivate(
        InformationOfGoodsTransferredInWarehousePublicPrivateWhereUniqueInput uniqueId
    );
