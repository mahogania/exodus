...
public class AtAndStandardExchangeDbModel
{
    ...
    [StringLength(1000)] public string? CustomsClearanceOfficeForAtEt { get; set; }

    public DateTime? DateAndTimeOfFinalModification { get; set; }

    public DateTime? DateAndTimeOfFirstRegistration { get; set; }

    [StringLength(1000)] public string? DateOfTheImportationDeclaration { get; set; }
    ...
    [StringLength(1000)] public string? ImportationDeclarationCode { get; set; }
    ...
    [StringLength(1000)] public string? RequestStatus { get; set; }
    ...
    [StringLength(1000)] public string? WarrantyEndDate { get; set; }

    [StringLength(1000)] public string? WarrantyFrame { get; set; }
}
