...
public class CommonRegimeRequestDbModel
{
    ...
    [StringLength(1000)] public string? ComplementaryRequestContent { get; set; }

    [StringLength(1000)] public string? ComplementaryRequestResponseContent { get; set; }
    ...
    [StringLength(1000)] public string? RegimeRequestContent { get; set; }

    [StringLength(1000)] public string? RegimeRequestNumber { get; set; }

    [StringLength(1000)] public string? RegimeRequestTitle { get; set; }

    [StringLength(1000)] public string? RegimeValidationDate { get; set; }
