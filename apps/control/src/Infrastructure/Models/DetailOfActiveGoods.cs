...
[Table("DetailOfActiveGoods")]
public class DetailOfActiveGoodsDbModel
{
    [StringLength(1000)]
    ...
    public string? CommonActiveGoodsRequestId { get; set; }

    [ForeignKey(nameof(CommonActiveGoodsRequestId))]
    public CommonActiveGoodsRequestDbModel? CommonActiveGoodsRequest { get; set; } = null;
