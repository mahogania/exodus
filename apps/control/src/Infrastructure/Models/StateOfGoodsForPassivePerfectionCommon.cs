...
public class StateOfGoodsForPassivePerfectionCommonDbModel
{
    ...
    [StringLength(1000)] public string? CustomsCodeOfExportDeclaration { get; set; }

    [StringLength(1000)] public string? CustomsCodeOfImportDeclaration { get; set; }

    [StringLength(1000)] public string? DeletionOn { get; set; }

    [StringLength(1000)] public string? DocumentCode { get; set; }

    [StringLength(1000)] public string? EndDateOfGrantedDeadline { get; set; }
    ...
    [StringLength(1000)] public string? NatureOfPassivePerfection { get; set; }
    ...
    [StringLength(1000)] public string? ReasonsCitedInFavorOfTheOperation { get; set; }
    ...
    [StringLength(1000)] public string? SpecifyOtherPaymentMethods { get; set; }

    [StringLength(1000)] public string? StartDateOfGrantedDeadline { get; set; }
