...
public class GoodsMacSuiteAtAndWithReExportationInStateDbModel
{
    ...
    [StringLength(1000)] public string? ConcernedArticleNumber { get; set; }

    [Required] public DateTime CreatedAt { get; set; }

    [StringLength(1000)] public string? CurrencyCode { get; set; }

    [Range(-999999999, 999999999)] public double? CurrencyValueOfGoods { get; set; }
    ...
    [Range(-999999999, 999999999)] public double? StoragePlace { get; set; }
