...
[Table("DetailOfRequestForOriginCertificates")]
public class DetailOfRequestForOriginCertificateDbModel
{
    [StringLength(1000)]
    ...
    public string? CommonOriginCertificateRequestId { get; set; }

    [ForeignKey(nameof(CommonOriginCertificateRequestId))]
    public CommonOriginCertificateRequestDbModel? CommonOriginCertificateRequest { get; set; } =
        null;
