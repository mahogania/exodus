...
public class TemporaryAdmissionOfVehicleDbModel
{
    ...
    [StringLength(1000)] public string? EntryCustomsOfficeCode { get; set; }
    ...
    [StringLength(1000)] public string? ReImportationReExportationOfficeCode { get; set; }
    ...
    [StringLength(1000)] public string? RequestedDelayEndDate { get; set; }

    [StringLength(1000)] public string? RequestedDelayStartDate { get; set; }
