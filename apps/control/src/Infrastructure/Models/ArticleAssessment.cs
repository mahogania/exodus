...
[Table("ArticleAssessments")]
public class ArticleAssessmentDbModel
{
    ...
    public string? ValueAssessmentId { get; set; }

    [ForeignKey(nameof(ValueAssessmentId))]
    public ValueAssessmentDbModel? ValueAssessment { get; set; } = null;
}
