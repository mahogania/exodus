...
public class DetailOfRequestForCertificateOfOriginDbModel
{
    ...
    [StringLength(1000)] public string? DescriptionOfTheMerchandise { get; set; }
    ...
    [StringLength(1000)] public string? InvoiceRefInvoice { get; set; }

    [Range(-999999999, 999999999)] public double? Quantity { get; set; }

    [Range(-999999999, 999999999)] public double? QuantityOfThePackage { get; set; }
    ...
    [StringLength(1000)] public string? TradeName { get; set; }

    [StringLength(1000)] public string? TypeOfPackagingCode { get; set; }

    [Required] public DateTime UpdatedAt { get; set; }

    [Range(-999999999, 999999999)] public double? Weight { get; set; }

    [StringLength(1000)] public string? WeightUnit { get; set; }
}
