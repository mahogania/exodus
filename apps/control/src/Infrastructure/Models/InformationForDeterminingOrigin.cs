...
{
    [Range(-999999999, 999999999)] public double? Amount { get; set; }
    ...
    [StringLength(1000)] public string? NameOfMaterialsUsed { get; set; }

    [Range(-999999999, 999999999)] public double? OriginDeterminationSeriesNumber { get; set; }
