...
{
    [StringLength(1000)] public string? BarcodeContent { get; set; }

    public DateTime? BarcodeTransmissionDateAndTime { get; set; }

    [StringLength(1000)] public string? CarrierCode { get; set; }

    [StringLength(1000)] public string? CommercialDenomination { get; set; }

    [Required] public DateTime CreatedAt { get; set; }

    [StringLength(1000)] public string? CustomsClearanceCode { get; set; }
    ...
    [StringLength(1000)] public string? ECommercialWebsite { get; set; }

    [StringLength(1000)] public string? ElectronicCommercialEnterpriseCertificationNumber { get; set; }

    [StringLength(1000)] public string? ExpressCustomsClearanceRequestNumber { get; set; }

    [StringLength(1000)] public string? ExpressCustomsClearanceTypeCode { get; set; }
    ...
    [StringLength(1000)] public string? HouseBlNumber { get; set; }
    ...
    [Range(-999999999, 999999999)] public double? PackageQuantity { get; set; }

    [StringLength(1000)] public string? ProcessingStatusCode { get; set; }

    [StringLength(1000)] public string? PurposeTypeCode { get; set; }

    [Range(-999999999, 999999999)] public double? Quantity { get; set; }

    [StringLength(1000)] public string? RecipientSAddress { get; set; }

    [StringLength(1000)] public string? RecipientSIdentificationCode { get; set; }
    ...
    [StringLength(1000)] public string? SenderSAddress { get; set; }

    [StringLength(1000)] public string? SenderSName { get; set; }

    [StringLength(1000)] public string? SenderSPhoneNumber { get; set; }
    ...
    [Range(-999999999, 999999999)] public double? SimpleCustomsDutyAmount { get; set; }
