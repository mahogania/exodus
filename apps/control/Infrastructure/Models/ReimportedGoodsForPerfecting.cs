...
public class ReimportedGoodsForPerfectingDbModel
{
    ...
    [StringLength(1000)] public string? CountryOfImportation { get; set; }
    ...
    [Range(-999999999, 999999999)] public double? FobValue { get; set; }

    [Key] [Required] public string Id { get; set; }

    [StringLength(1000)] public string? NatureOfGoodsRemainingOutsideTheCustomsTerritory { get; set; }

    [StringLength(1000)] public string? Origin { get; set; }

    [Range(-999999999, 999999999)] public double? Quantity { get; set; }

    [Range(-999999999, 999999999)] public double? QuantityOfEachGoodRemainingOutsideTheCustomsTerritory { get; set; }
