...
public class MacSuiteAtWithReexportationInTheStateDbModel
{
    ...
    [StringLength(1000)] public string? AtDeclarationDate { get; set; }

    [StringLength(1000)] public string? AtDeclarationNumber { get; set; }

    [StringLength(1000)] public string? BusinessRegisterNumber { get; set; }

    [StringLength(1000)] public string? ContentOfTheRequestReason { get; set; }

    [Required] public DateTime CreatedAt { get; set; }

    [StringLength(1000)] public string? CustomsClearanceOfficeForMac { get; set; }
    ...
    [StringLength(1000)] public string? Importer { get; set; }
