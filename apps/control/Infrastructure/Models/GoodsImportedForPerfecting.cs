...
{
    [StringLength(1000)] public string? AddressOfTheExporterOwnerOfGoodsToTransformRepair { get; set; }

    [Range(-999999999, 999999999)] public double? AnotherUnknownField { get; set; }

    [StringLength(1000)] public string? CommercialDesignationOfGoods { get; set; }

    [StringLength(1000)] public string? CommercialDesignationOfGoodsToCompensate { get; set; }

    [Range(-999999999, 999999999)] public double? CompensationOfAtAccounts { get; set; }
    ...
    [StringLength(1000)] public string? LegalStatusOfImportedGoods { get; set; }

    [StringLength(1000)] public string? NameAndTradeNameOfTheExporterOwnerOfGoodsToTransformRepair { get; set; }

    [StringLength(1000)] public string? Origin { get; set; }

    [Range(-999999999, 999999999)] public double? Quantity { get; set; }

    [Range(-999999999, 999999999)] public double? QuantityOfGoodsToCompensate { get; set; }
    ...
    [StringLength(1000)] public string? ShorterOrigin { get; set; }

    [StringLength(1000)] public string? SptNumber { get; set; }

    [StringLength(1000)] public string? TechnicalDesignationOfGoods { get; set; }

    [StringLength(1000)] public string? TechnicalDesignationOfGoodsToCompensate { get; set; }

    [Range(-999999999, 999999999)] public double? UnknownField { get; set; }

    [Required] public DateTime UpdatedAt { get; set; }

    [Range(-999999999, 999999999)] public double? ValueInCurrency { get; set; }
}
