...
public class InfosGoodsToBeReprovisionedDbModel
{
    ...
    [StringLength(1000)] public string? NatureOfTheGoods { get; set; }

    [StringLength(1000)] public string? NumberOfTheConcernedArticle { get; set; }

    [StringLength(1000)] public string? Origin { get; set; }

    [StringLength(1000)] public string? ProposedMeansForTheQuantitativeAndTechnicalControlOfEquivalence { get; set; }

    [StringLength(1000)] public string? Provenance { get; set; }

    [Range(-999999999, 999999999)] public double? QuantityIncludingNonRecoverableWaste { get; set; }

    [Range(-999999999, 999999999)] public double? RectificationFrequency { get; set; }

    [StringLength(1000)] public string? ReferencesOfTheConcernedArticleModelS { get; set; }
    ...
    [StringLength(1000)] public string? TechnicalCharacteristics { get; set; }
