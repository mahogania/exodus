...
[Table("ExportedOrToBeExportedGoodsInformations")]
public class ExportedOrToBeExportedGoodsInformationDbModel
{
    [StringLength(1000)] public string? ArticleNumber { get; set; }

    [StringLength(1000)] public string? CommercialDesignationOfTheGoods { get; set; }
    ...
    [StringLength(1000)] public string? DestinationCountry { get; set; }
    ...
    [StringLength(1000)] public string? TechnicalDesignationOfTheGoods { get; set; }
