...
public class FinalExportFollowedByReimportationInTheStateDbModel
{
    ...
    [StringLength(1000)] public string? ContentOfTheRequestReason { get; set; }

    [Required] public DateTime CreatedAt { get; set; }

    [StringLength(1000)] public string? CustomsClearanceOfficeForFinalExportFollowedByEt { get; set; }

    [StringLength(1000)] public string? CustomsDeclarationOffice { get; set; }

    public DateTime? DateAndTimeOfFinalModification { get; set; }

    public DateTime? DateAndTimeOfFirstRegistration { get; set; }

    [StringLength(1000)] public string? DateOfEtDeclaration { get; set; }

    [StringLength(1000)] public string? EpcCode { get; set; }

    [StringLength(1000)] public string? EtDeclarationNumber { get; set; }
