...
public class DetailsOfGoodsForPassivePerfectionDbModel
{
    ...
    [StringLength(1000)] public string? DeclaredGoodsNames { get; set; }
    ...
    [StringLength(1000)] public string? NatureOfGoodsCode { get; set; }
    ...
    [StringLength(1000)] public string? TechnicalName { get; set; }
