...
{
    [StringLength(1000)] public string? CommercialDesignationOfTheMaterials { get; set; }
    ...
    [Range(-999999999, 999999999)] public double? FobValueInCurrency { get; set; }

    [Range(-999999999, 999999999)] public double? FobValueInDa { get; set; }
    ...
    [StringLength(1000)] public string? StateOfTheMaterialsAtTheTimeOfImportation { get; set; }

    [StringLength(1000)] public string? SuppressionOn { get; set; }

    [StringLength(1000)] public string? TechnicalDesignationOfTheMaterials { get; set; }
