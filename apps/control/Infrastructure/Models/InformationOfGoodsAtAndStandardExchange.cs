...
{
    [StringLength(1000)] public string? AddressOfTheSupplierRecipientOfTheGoods { get; set; }
    ...
    [StringLength(1000)] public string? NameAndBusinessNameOfTheSupplierRecipientOfTheGoods { get; set; }

    [StringLength(1000)] public string? Origin { get; set; }

    [StringLength(1000)] public string? ProvenanceDestination { get; set; }
