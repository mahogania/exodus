...
public class MacSubjectToAuthorizationDbModel
{
    ...
    [StringLength(1000)] public string? CountryOfDestination { get; set; }

    [StringLength(1000)] public string? CountryOfOrigin { get; set; }

    [Required] public DateTime CreatedAt { get; set; }

    [StringLength(1000)] public string? CustomsOfficeForMacClearance { get; set; }
    ...
    [StringLength(1000)] public string? PreviousDeclarationDate { get; set; }

    [StringLength(1000)] public string? PreviousDeclarationNumber { get; set; }

    [StringLength(1000)] public string? ReasonForTheRequest { get; set; }

    [StringLength(1000)] public string? RecipientSupplier { get; set; }
