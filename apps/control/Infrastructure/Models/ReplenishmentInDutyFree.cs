...
[Table("ReplenishmentInDutyFrees")]
public class ReplenishmentInDutyFreeDbModel
{
    [StringLength(1000)] public string? ApcCode { get; set; }

    [Required] public DateTime CreatedAt { get; set; }

    [StringLength(1000)] public string? CustomsClearanceOfficeForReplenishmentInDutyFree { get; set; }
    ...
    [StringLength(1000)] public string? DateOfDau { get; set; }
    ...
    [StringLength(1000)] public string? ExportDeclarationNumber { get; set; }
