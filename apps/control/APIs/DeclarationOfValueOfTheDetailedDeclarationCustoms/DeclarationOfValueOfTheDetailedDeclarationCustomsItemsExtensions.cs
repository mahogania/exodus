...
public static class DeclarationOfValueOfTheDetailedDeclarationCustomsItemsExtensions
{
    public static DeclarationOfValueOfTheDetailedDeclarationCustoms ToDto(
        this DeclarationOfValueOfTheDetailedDeclarationCustomsDbModel model
    )
    {
        return new DeclarationOfValueOfTheDetailedDeclarationCustoms
        {
    ...
    public static DeclarationOfValueOfTheDetailedDeclarationCustomsDbModel ToModel(
        this DeclarationOfValueOfTheDetailedDeclarationCustomsUpdateInput updateDto,
        ...
        var declarationOfValueOfTheDetailedDeclarationCustoms =
            new DeclarationOfValueOfTheDetailedDeclarationCustomsDbModel
            {
                ...
                AdditionalCostOfPurchaseCommissionOn =
                    updateDto.AdditionalCostOfPurchaseCommissionOn,
                ...
                BaseForCalculatingTransactionalValue =
                    updateDto.BaseForCalculatingTransactionalValue,
                ...
                TotalDeductedAmountOfAdditionalCosts =
                    updateDto.TotalDeductedAmountOfAdditionalCosts
            };
