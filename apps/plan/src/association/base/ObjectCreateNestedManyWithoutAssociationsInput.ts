...
@InputType()
class ObjectCreateNestedManyWithoutAssociationsInput {
...
export { ObjectCreateNestedManyWithoutAssociationsInput as ObjectCreateNestedManyWithoutAssociationsInput };
