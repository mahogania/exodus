...
@InputType()
class AssociationUpdateManyWithoutAssociationTypesInput {
...
export { AssociationUpdateManyWithoutAssociationTypesInput as AssociationUpdateManyWithoutAssociationTypesInput };
