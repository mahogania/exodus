...
export class PropertyResolverBase {
  ...
  async createProperty(
    ...
    return await this.service.createProperty({
      ...
      data: {
        ...
        dynamicProperty: args.data.dynamicProperty
          ? {
              connect: args.data.dynamicProperty,
            }
          : undefined,
  ...
  async getDynamicProperty(
    @graphql.Parent() parent: Property
  ): Promise<PropertyType | null> {
    const result = await this.service.getDynamicProperty(parent.id);
  ...
  async getObject(@graphql.Parent() parent: Property): Promise<Object | null> {
